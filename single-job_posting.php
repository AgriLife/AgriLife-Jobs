				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<section class="entry-content">
						...
						<div class="job-posting-details">
							...
							<?php if ($website) { ?>
							<dt class="job-posting-dt job-posting-website">Website</dt>
							...
							<?php if ($description) { ?>
							<dt class="job-posting-dt job-posting-description">Description</dt>
								<dd class="job-posting-dd"><?php echo $description;?></dd>
							<?php } ?>

							<?php if ($qualifications) { ?>
							<dt class="job-posting-dt job-posting-qualifications">Qualifications</dt>
